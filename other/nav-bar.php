                ...
                <ul class="navbar-nav mb-2 mb-lg-0">
                    <?php if (empty($_SESSION['user1'])) : ?>
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="login-api.php" role="button" data-bs-toggle="dropdown">登入</a>
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown">註冊</a>
                            <ul class="dropdown-menu dropdown-menu-lg-end">
                                <li><a class="dropdown-item" href="#">會員</a></li>
                                <li><a class="dropdown-item" href="#">商家</a></li>
                            </ul>
